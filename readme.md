...
<p align="center">
  <b>Origin:</b> This project is a feature-enhanced fork of the original <a href="https://github.com/martineastwood/featuristic">Featuristic</a> library by <a href="https://github.com/martineastwood">Martin Eastwood</a>.
</p>

<div align="center">

  <a href="">[![Python Version](https://img.shields.io/pypi/pyversions/featuristic-categorical)](https://pypi.org/project/featuristic-categorical/)</a>
  <a href="">[![PyPI](https://img.shields.io/pypi/v/featuristic-categorical.svg)](https://pypi.org/project/featuristic-categorical/)</a>
  <a href="">[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)</a>
  <a href='https://github.com/alfiq/featuristic-categorical'><img src='https://img.shields.io/badge/GitHub-Repo-blue?logo=github' alt='GitHub Repo' /></a>
...
[Featuristic-Categorical](https://github.com/alfiq/featuristic-categorical) is an enhanced fork of the original [Featuristic](https://www.featuristic.co.uk/) that adds robust support for **categorical variables** and **feature interactions**. It uses Genetic Algorithms to automate the process of feature engineering and selection, intelligently deriving new insights from both numeric and string data.

## Installation

Install our enhanced version with categorical support from GitHub:

```bash
python3 -m pip install git+https://github.com/alfiq/featuristic-categorical.git
```

## Understanding Genetic Feature Synthesis

Featuristic uses symbolic regression to intelligently derive interpretable mathematical formulas and logical transformations, which are then used to create new features from your dataset.

### New: Advanced Categorical Support
Unlike standard symbolic regression, this version includes first-class support for categorical data through:
*   **Stateful Encoding**: `cat_codes`, `freq_encode`, and `target_encode` intelligently learn mappings from your training data and apply them consistently to new data.
*   **Feature Interactions**: `combine` (feature crossing) and `hash_interact` for high-cardinality categorical pairs.
*   **Group Aggregations**: Automatically derive features based on numerical distributions grouped by categories, such as `group_mean`, `group_std`, `group_diff` (value minus group mean), and `group_ratio`.

### Process Overview
Initially, Featuristic creates a diverse population of formulas using fundamental mathematical operators (`add`, `subtract`, `sin`, etc.) and categorical operators (`group_mean`, `combine`, etc.).

For instance, a formula generated by Featuristic might look like this: `group_diff(category_feature, numeric_feature) * target_encode(other_category)`.
